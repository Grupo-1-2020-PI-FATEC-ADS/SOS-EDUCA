        ...
        <div class="col-lg-4 pb-5">
            ...
            <div class="wizard">
                <nav class="list-group list-group-flush">
                    <a class="list-group-item" href="cliente_index.php">
                    ...
                    <a class="list-group-item active" href="cliente_senha.php"><i class="fa fa-lock text-muted"></i>Atualização de Senha</a>
