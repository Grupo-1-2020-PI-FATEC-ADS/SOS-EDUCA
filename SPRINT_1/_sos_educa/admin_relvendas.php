                    ...
                    ?>
                      ...
                      <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOne<?php=$row['id_venda']?>" aria-expanded="false" aria-controls="collapseOne">
                                Clique aqui para verificar os Itens comprados
                                </button>
                                <div id="collapseOne<?php=$row['id_venda']?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                                <ul>
